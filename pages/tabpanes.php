...
<!--MERGE SORT-->
<div class="tab-pane" id="mergeSort" data-toggle="tab">
    <h1 class="page-header">Merge Sort</h1>
</div>
<!--Quick SORT-->
<div class="tab-pane" id="quickSort" data-toggle="tab">
    <h1 class="page-header">Quick Sort</h1>
</div>
<!--SELECTION SORT-->
<div class="tab-pane" id="selectionSort" data-toggle="tab">
    <h1 class="page-header">selection Sort</h1>
</div>
<!--INSERTION SORT-->
<div class="tab-pane" id="insertionSort" data-toggle="tab">
    <h1 class="page-header">insertion Sort</h1>
</div>
<!--BUBBLE SORT-->
<div class="tab-pane" id="bubbleSort" data-toggle="tab">
    <h1 class="page-header">Bubble Sort</h1>
</div>
<!--////////SORTING-->

<!--ELEMENTARY DS-->
<!--PRIORITY QUEUES-->
<div class="tab-pane" id="priorityQueues" data-toggle="tab">
    <h1 class="page-header">Priority Queues</h1>
</div>
<!-- LINKED LISTS -->
<div class="tab-pane" id="linkedLists" data-toggle="tab">
    <h1 class="page-header">Linked Lists</h1>
</div>
<!-- PRIORITY QUEUES -->
<div class="tab-pane" id="heaps" data-toggle="tab">
    <h1 class="page-header">heaps</h1>
</div>
<!--////ELEMENTARY DS-->

<!--TREES--> 
<!--BINARY TREE-->
<div class="tab-pane" id="binaryTree" data-toggle="tab">
    <h1 class="page-header">binary tree</h1>
</div>
<!--TREE TRAVERSAL-->
<div class="tab-pane" id="treeTraversal" data-toggle="tab">
    <h1 class="page-header">tree traversal</h1>
</div>
<!--BINARY SEARCH TREE-->
<div class="tab-pane" id="binarySearchTree" data-toggle="tab">
    <h1 class="page-header">binary search tree</h1>
</div>
<!--///TREES-->

<!--SEARCHING-->
<!--LINEAR-->
<div class="tab-pane" id="linear" data-toggle="tab">
    <h1 class="page-header">linear search</h1>
</div>
<!--BINARY-->
<div class="tab-pane" id="binary" data-toggle="tab">
...
<!--GRAPHS-->
<!--TOPOLOGICAL SORT-->
<div class="tab-pane" id="topologicalSort" data-toggle="tab">
    <h1 class="page-header">Topological Sort</h1>
</div>
<!--MINIMUM SPANNING TREES-->
<div class="tab-pane" id="minimumSpaningTrees" data-toggle="tab">
    <h1 class="page-header">minimum spanning Trees</h1>
</div>
<!--SHORTEST PATHS-->
<div class="tab-pane" id="shortestPaths" data-toggle="tab">
    <h1 class="page-header">shortest paths</h1>
</div>
